...
public class AdminController extends Controller {
	...
	Form<Size> size = formFactory.form(Size.class);
	Form<Size> size2 = formFactory.form(Size.class);
	Form<Size> size3 = formFactory.form(Size.class);

		

        // Render the Add Product View, passing the form object
        return ok(addProduct.render(addProductForm, getUserFromSession(), size, size2));
    }
