...
package controllers {
  ...
  class ReverseHomeController(_prefix: => String) {
    ...
    // @LINE:11
    def productDetails(cat:Long = 0, filter:String = "", id:Long, sId:Long = 0): Call = {
      import ReverseRouteContext.empty
      Call("GET", _prefix + { _defaultPrefix } + "productDetails/" + implicitly[PathBindable[Long]].unbind("id", id) + queryString(List(if(cat == 0) None else Some(implicitly[QueryStringBindable[Long]].unbind("cat", cat)), if(filter == "") None else Some(implicitly[QueryStringBindable[String]].unbind("filter", filter)), if(sId == 0) None else Some(implicitly[QueryStringBindable[Long]].unbind("sId", sId)))))
    }
  ...
  class ReverseShoppingCtrl(_prefix: => String) {
    ...
    // @LINE:29
    def addOne(itemId:Long, cat:Long = 0, filter:String = "", sId:Long = 0): Call = {
      import ReverseRouteContext.empty
      Call("GET", _prefix + { _defaultPrefix } + "addOne/" + implicitly[PathBindable[Long]].unbind("itemId", itemId) + queryString(List(if(cat == 0) None else Some(implicitly[QueryStringBindable[Long]].unbind("cat", cat)), if(filter == "") None else Some(implicitly[QueryStringBindable[String]].unbind("filter", filter)), if(sId == 0) None else Some(implicitly[QueryStringBindable[Long]].unbind("sId", sId)))))
    }
    ...
    // @LINE:27
    def addToBasket(id:Long, cat:Long = 0, filter:String = "", sId:Long): Call = {
    
      (id: @unchecked, cat: @unchecked, filter: @unchecked, sId: @unchecked) match {
      
        // @LINE:27
        case (id, cat, filter, sId)  =>
          import ReverseRouteContext.empty
          Call("GET", _prefix + { _defaultPrefix } + "addToBasket/" + implicitly[PathBindable[Long]].unbind("id", id) + queryString(List(if(cat == 0) None else Some(implicitly[QueryStringBindable[Long]].unbind("cat", cat)), if(filter == "") None else Some(implicitly[QueryStringBindable[String]].unbind("filter", filter)), if(sId == 0) None else Some(implicitly[QueryStringBindable[Long]].unbind("sId", sId)))))
    ...
    // @LINE:26
    def showBasket(id:Long = 0, filter:String = "", sId:Long = 0): Call = {
      import ReverseRouteContext.empty
      Call("GET", _prefix + { _defaultPrefix } + "showBasket" + queryString(List(if(id == 0) None else Some(implicitly[QueryStringBindable[Long]].unbind("id", id)), if(filter == "") None else Some(implicitly[QueryStringBindable[String]].unbind("filter", filter)), if(sId == 0) None else Some(implicitly[QueryStringBindable[Long]].unbind("sId", sId)))))
    }
  
    // @LINE:31
    def emptyBasket(cat:Long = 0, filter:String = "", sId:Long = 0): Call = {
      import ReverseRouteContext.empty
      Call("GET", _prefix + { _defaultPrefix } + "emptyBasket" + queryString(List(if(cat == 0) None else Some(implicitly[QueryStringBindable[Long]].unbind("cat", cat)), if(filter == "") None else Some(implicitly[QueryStringBindable[String]].unbind("filter", filter)), if(sId == 0) None else Some(implicitly[QueryStringBindable[Long]].unbind("sId", sId)))))
    }
  
    // @LINE:30
    def removeOne(itemId:Long, cat:Long = 0, filter:String = "", sId:Long = 0): Call = {
      import ReverseRouteContext.empty
      Call("GET", _prefix + { _defaultPrefix } + "removeOne/" + implicitly[PathBindable[Long]].unbind("itemId", itemId) + queryString(List(if(cat == 0) None else Some(implicitly[QueryStringBindable[Long]].unbind("cat", cat)), if(filter == "") None else Some(implicitly[QueryStringBindable[String]].unbind("filter", filter)), if(sId == 0) None else Some(implicitly[QueryStringBindable[Long]].unbind("sId", sId)))))
    }
